...
use crate::pattern::{
    ...
    P133StaircaseAsAStage, P21FourStoryLimit, P221NaturalDoorsAndWindows, P29DensityRings,
    P37HouseCluster, P61SmallPublicSquares, P67CommonLand, P95BuildingComplexOpinion,
