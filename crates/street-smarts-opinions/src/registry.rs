...
use crate::pattern::{
    ...
    P114HierarchyOfOpenSpace, P115CourtyardsWhichLive, P130EntranceRoom, P133StaircaseAsAStage,
    P165OpeningToTheStreet, P21FourStoryLimit, P221NaturalDoorsAndWindows, P29DensityRings,
    P30ActivityNodes, P37HouseCluster, P49LoopedLocalRoads, P50TJunctions, P60AccessibleGreen,
    P61SmallPublicSquares, P67CommonLand, P95BuildingComplexOpinion, P99MainBuilding,
    P106PositiveOutdoorSpace, P127IntimacyGradient, P128IndoorSunlight, P129CommonAreasAtTheHeart,
    P131TheFlowThroughRooms, P159LightOnTwoSides,
};
