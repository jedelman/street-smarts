/* @ts-self-types="./street_smarts_web.d.ts" */
 ...
 * @returns {string}
 */
export function analyze_neighborhood(neighborhood_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        wasm.analyze_neighborhood(retptr, ptr0, len0);
 ...
 * @returns {string}
 */
export function list_operators() {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.list_operators(retptr);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        var r3 = getDataViewMemory0().getInt32(retptr + 4 * 3, true);
...
export function subdivide_parcel(neighborhood_json, parcel_id, operator_name, seed) {
    ...
    try {
        ...
        const ptr0 = passStringToWasm0(neighborhood_json, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(parcel_id, wasm.__wbindgen_export, wasm.__wbindgen_export2);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./street_smarts_web_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('street_smarts_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
